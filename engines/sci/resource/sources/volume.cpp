...
void VolumeResourceSource::loadResource(const ResourceManager *resMan, Resource *res) const {
...
ResourceErrorCode VolumeResourceSource::decompress(const ResourceManager *resMan, Resource *res, Common::SeekableReadStream *file) const {
