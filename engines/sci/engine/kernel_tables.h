...
#define SIG_SOUNDSCI1LATE  SCI_VERSION_1_MIDDLE, SCI_VERSION_1_1
#define SIG_SOUNDSCI1      SCI_VERSION_1_MIDDLE, SCI_VERSION_NONE
...
static const SciKernelMapSubEntry kDoSound_subops[] = {
	...
	{ SIG_SOUNDSCI0,       7, MAP_EMPTY(DoSoundResumeAfterRestore), "",                    NULL },
	{ SIG_SOUNDSCI0,       8, MAP_CALL(DoSoundMasterVolume),       "(i)",                  NULL },
	{ SIG_SOUNDSCI0,       9, MAP_CALL(DoSoundUpdate),             "o",                    NULL },
	{ SIG_SOUNDSCI0,      10, MAP_CALL(DoSoundFade),               "[o0]",                 NULL },
	{ SIG_SOUNDSCI0,      11, MAP_CALL(DoSoundGetPolyphony),       "",                     NULL },
	{ SIG_SOUNDSCI0,      12, MAP_DUMMY(DoSoundStopAll),           "",                     NULL },

	{ SIG_SOUNDSCI1EARLY,  0, MAP_CALL(DoSoundMasterVolume),       "(i)",                  NULL },
	{ SIG_SOUNDSCI1EARLY,  1, MAP_CALL(DoSoundMute),               "(i)",                  NULL },
	{ SIG_SOUNDSCI1EARLY,  2, MAP_EMPTY(DoSoundRestore),           "(.*)",                 NULL },
	{ SIG_SOUNDSCI1EARLY,  3, MAP_CALL(DoSoundGetPolyphony),       "",                     NULL },
	{ SIG_SOUNDSCI1EARLY,  4, MAP_CALL(DoSoundUpdate),             "o",                    NULL },
	{ SIG_SOUNDSCI1EARLY,  5, MAP_CALL(DoSoundInit),               "o",                    NULL },
	{ SIG_SOUNDSCI1EARLY,  6, MAP_CALL(DoSoundDispose),            "o",                    NULL },
	{ SIG_SOUNDSCI1EARLY,  7, MAP_CALL(DoSoundPlay),               "oi",                   NULL },
	{ SIG_SOUNDSCI1EARLY,  8, MAP_CALL(DoSoundStop),               "o",                    NULL },
	...
	{ SIG_SOUNDSCI1EARLY, 15, MAP_EMPTY(DoSoundDummy),             "",                     NULL }, // Longbow demo

	{ SIG_SOUNDSCI1,       0, MAP_CALL(DoSoundMasterVolume),       "(i)",                  NULL },
	{ SIG_SOUNDSCI1,       1, MAP_CALL(DoSoundMute),               "(i)",                  NULL },
	{ SIG_SOUNDSCI1,       2, MAP_EMPTY(DoSoundRestore),           "(.*)",                 NULL },
