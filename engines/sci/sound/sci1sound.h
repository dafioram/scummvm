...
#ifndef SCI_SOUND_SCI1SOUND_H
#define SCI_SOUND_SCI1SOUND_H
...
#pragma mark -
#pragma mark Sci1SoundManager

class Sci1SoundManager final : public SoundManager {
public:
	Sci1SoundManager(ResourceManager &resMan, SegManager &segMan, GameFeatures &features, GuestAdditions &guestAdditions);
	~Sci1SoundManager();

	virtual void reset() override { _defaultReverbMode = 0; }
...
#pragma mark Kernel
public:
	virtual void kernelInit(const reg_t soundObj) override;
	...
	virtual void kernelSetPriority(const reg_t soundObj, const int16 priority) override;
	virtual void kernelSetLoop(const reg_t soundObj, const bool enable) override;
	virtual void kernelUpdateCues(const reg_t soundObj) override;
	virtual void kernelSendMidi(const int argc, const reg_t *const argv) override;
	virtual void kernelUpdate(const reg_t soundObj) override;
	virtual reg_t kernelGlobalReverb(const int argc, const reg_t *const argv) override;
